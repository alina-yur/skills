...
- `skills/db/security/privilege-management.md` for least privilege and role design
- `skills/db/security/row-level-security.md` for VPD or FGAC
- `skills/db/security/auditing.md` for Unified Auditing and FGA
- `skills/db/security/network-security.md` for ACLs, TLS, and network hardening
